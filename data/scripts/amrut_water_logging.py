...
# The Resource ID for "State/UTs-wise list of AMRUT cities where Water Logging points have been eliminated through AMRUT Projects (Reply to Unstarred Question on 03 August 2023)"
RESOURCE_ID = "caadd339-a9a7-47bc-adbe-671bf57ad3fe"

# The standard data.gov.in API endpoint
API_URL = "https://api.data.gov.in/resource/" + RESOURCE_ID

OUTPUT_FILE = os.path.join(os.path.dirname(__file__), 'amrut_water_logging.json')
