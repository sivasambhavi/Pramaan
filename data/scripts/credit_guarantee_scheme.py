...
# The Resource ID for "State/UTs-wise Details of Number and Amount of Guarantees Approved under Credit Guarantee Scheme"
RESOURCE_ID = "63fd4393-ee70-4fc7-bf84-cc4d4d29fed5"

# The standard data.gov.in API endpoint
API_URL = "https://api.data.gov.in/resource/" + RESOURCE_ID

OUTPUT_FILE = os.path.join(os.path.dirname(__file__), 'credit_guarantee_scheme.json')
