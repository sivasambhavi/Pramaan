...
# The Resource ID for "State/UTs-wise details of toilets constructed under SBM (Swachh Bharat Mission) Urban areas"
...
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), 'sbm_toilets.json')
